...
void initChangeTables(void)
{
	...
	set_sc( SK_RA_LEADEROFTHEPACK	, STATUS_LEADEROFTHEPACK	, EFST_LEADEROFTHEPACK, SCB_WATK|SCB_MATK );
	...
	set_sc( SK_HT_CALL_WARG			, STATUS_WARG_TRAINING		, EFST_WARG_TRAINING, SCB_NONE );
	set_sc( SK_HT_CALL_FALCON			, STATUS_FALCONRY		, EFST_FALCONRY, SCB_NONE );
	...
	set_sc( SK_CR_GEOGRAFIELD	, STATUS_GEOGRAFIELD, EFST_GEOGRAFIELD, SCB_NONE );
	...
	set_sc( SK_ST_CHEATSKILL	, STATUS_CHEATSKILL	, EFST_AUTOSHADOWSPELL	, SCB_NONE );
