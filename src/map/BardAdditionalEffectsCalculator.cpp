...
{
	status_change_start(src, bl, STATUS_CONFUSION, 10000, skill_lv, 0, 0, 0, skill_lv * 1000, SCSTART_NONE);
}
...
{
	status_change_start(src, bl, STATUS_CONFUSION, 200*skill_lv, skill_lv, 0, 0, 0, 5000, SCSTART_NONE);
}
