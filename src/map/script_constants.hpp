...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_COMBO1);
	export_constant(SC_COMBO2);
	export_constant(SC_COMBO3);
	export_constant(SC_COMBO4);
	export_constant(SC_COMBO5);
	export_constant(SC_COMBO6);
	export_constant(SC_COMBO7);
	export_constant(SC_COMBO8);
	export_constant(SC_COMBO9);
	export_constant(SC_COMBO10);
	...
	export_constant(SC_COIN_DEX);
	export_constant(SC_COIN_LUK);
