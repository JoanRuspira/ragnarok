...
#define SCRIPT_CONSTANTS_HPP
	...
	/* status changes */
	export_constant2("Eff_Stone", STATUS_STONECURSE);
	export_constant2("Eff_Freeze", STATUS_FREEZE);
	export_constant2("Eff_Stun", STATUS_STUN);
	export_constant2("Eff_Sleep", STATUS_SLEEP);
	export_constant2("Eff_Poison", STATUS_POISON);
	export_constant2("Eff_Curse", STATUS_CURSE);
	export_constant2("Eff_Silence", STATUS_SILENCE);
	export_constant2("Eff_Confusion", STATUS_CONFUSION);
	export_constant2("Eff_Blind", STATUS_BLIND);
	export_constant2("Eff_Bleeding", STATUS_BLEEDING);
	export_constant2("Eff_DPoison", STATUS_DPOISON);

	export_constant2("SC_ALL", STATUS_NONE);

	export_constant(STATUS_NONE);
	export_constant(STATUS_STONECURSE);
	export_constant(STATUS_COMMON_MIN);
	export_constant(STATUS_FREEZE);
	export_constant(STATUS_STUN);
	export_constant(STATUS_SLEEP);
	export_constant(STATUS_POISON);
	export_constant(STATUS_CURSE);
	export_constant(STATUS_SILENCE);
	export_constant(STATUS_CONFUSION);
	export_constant(STATUS_BLIND);
	export_constant(STATUS_BLEEDING);
	export_constant(STATUS_DPOISON); 
	export_constant(STATUS_COMMON_MAX); 
	export_constant(STATUS_PROVOKE);
	export_constant(STATUS_ANGER);
	export_constant(STATUS_SPEARSTANCE);
	export_constant(STATUS_SPIRITGROWTH);
	export_constant(STATUS_WATK_ELEMENT);
	export_constant(STATUS_TWOHANDQUICKEN);
	export_constant(STATUS_ADRENALINERUSH);
	export_constant(STATUS_FURY);
	export_constant(STATUS_RECKONING);
	export_constant(STATUS_AUTOCOUNTER);
	export_constant(STATUS_SPEARQUICKEN);
	export_constant(STATUS_VIGOR);
	export_constant(STATUS_STONESKIN);
	export_constant(STATUS_ONEHANDQUICKEN);
	export_constant(STATUS_ENCHANTBLADE);
	export_constant(STATUS_FRENZY);
	export_constant(STATUS_AURABLADE);
	export_constant(STATUS_SPEARDYNAMO);
	export_constant(STATUS_PARRY);
	export_constant(STATUS_MILLENIUMSHIELDS);
	export_constant(STATUS_SWORNPROTECTOR);
	export_constant(STATUS_AUTOGUARD);
	export_constant(STATUS_REFLECTSHIELD);
	export_constant(STATUS_VANGUARDFORCE);
	export_constant(STATUS_GOSPEL);
	export_constant(STATUS_FORTIFY);
	export_constant(STATUS_DEFENDINGAURA);
	export_constant(STATUS_LOUDEXCLAMATION);
	export_constant(STATUS_CRAZYUPROAR);
	export_constant(STATUS_COINFLIP_DEX);
	export_constant(STATUS_COINFLIP_LUK);
	export_constant(STATUS_CARTBOOST);
	export_constant(STATUS_ENDURE);
	export_constant(STATUS_WEAPONRYEXPERTISE);
	export_constant(STATUS_WEAPONSHARPENING);
	export_constant(STATUS_MAXIMIZEPOWER);
	export_constant(STATUS_POWERTHRUST);
	export_constant(STATUS_AXEQUICKEN);
	export_constant(STATUS_MELTDOWN);
	...
	export_constant(STATUS_CP_ARMOR);
	export_constant(STATUS_CP_HELM);
	export_constant(STATUS_QUAGMIRE);
	export_constant(STATUS_ENERGYCOAT);
	export_constant(STATUS_SPELLBOOK1);
	export_constant(STATUS_SPELLBOOK2);
	export_constant(STATUS_SPELLBOOK3);
	export_constant(STATUS_SPELLBOOK4);
	export_constant(STATUS_SPELLBOOK5);
	export_constant(STATUS_SPELLBOOK6);
	export_constant(STATUS_MAXSPELLBOOK);
	export_constant(STATUS_STORE_SPELLBOOK);
	export_constant(STATUS_FORESIGHT);
	export_constant(STATUS_PARALYSIS);
	export_constant(STATUS_HINDSIGHT);
	export_constant(STATUS_MYSTICALAMPLIFICATION);
	export_constant(STATUS_ASTRALSTRIKE_DEBUFF);
	export_constant(STATUS_VOIDMAGEPRODIGY);
	export_constant(STATUS_BOOKQUICKEN);
	export_constant(STATUS_AUTOSPELL);
	export_constant(STATUS_MINDGAMES);
	export_constant(STATUS_MAGICCELL);
	export_constant(STATUS_SPELLFIST);
	export_constant(STATUS_MAGICSQUARED);
	export_constant(STATUS_STASIS);
	export_constant(STATUS_CRUCIS_PLAYER);
	export_constant(STATUS_MACEQUICKEN);
	export_constant(STATUS_RENEW);
	export_constant(STATUS_RUWACH); //no icon
	export_constant(STATUS_ANGELUS);
	export_constant(STATUS_BLESSING);
	export_constant(STATUS_INCREASEAGI);
	export_constant(STATUS_LEXAETERNA);
	export_constant(STATUS_ASPERSIO);
	export_constant(STATUS_IMPOSITIOMANUS);
	export_constant(STATUS_DUPLELUX);
	export_constant(STATUS_KYRIE);
	export_constant(STATUS_MAGNIFICAT);
	export_constant(STATUS_SUFFRAGIUM);
	export_constant(STATUS_LAUDATEDOMINIUM);
	export_constant(STATUS_OFFERTORIUM);
	export_constant(STATUS_EXPIATIO);
	export_constant(STATUS_INLUCEMBATALIA);
	export_constant(STATUS_BENEDICTIO);
	export_constant(STATUS_ASSUMPTIO);
	export_constant(STATUS_DECREASEAGI);
	export_constant(STATUS_KNUCKLEQUICKEN);
	export_constant(STATUS_COMBO1);
	export_constant(STATUS_COMBO2);
	export_constant(STATUS_COMBO3);
	export_constant(STATUS_COMBO4);
	export_constant(STATUS_COMBO5);
	export_constant(STATUS_COMBO6);
	export_constant(STATUS_COMBO7);
	export_constant(STATUS_COMBO8);
	export_constant(STATUS_COMBO9);
	export_constant(STATUS_COMBO10);
	export_constant(STATUS_DEFENSIVESTANCE);
	export_constant(STATUS_ULTRAINSTINCT);
	export_constant(STATUS_ASURASTRIKE);
	export_constant(STATUS_GRAPPLE_WAIT);
	export_constant(STATUS_GRAPPLE);
	export_constant(STATUS_MENTALSTRENGTH);
	export_constant(STATUS_POISONREACT);
	export_constant(STATUS_HIDING);
	export_constant(STATUS_ROLLINGCUTTER);
	export_constant(STATUS_CLOAKING);
	export_constant(STATUS_CHASEWALK);
	export_constant(STATUS_CHASEWALK2);
	export_constant(STATUS_ENCHANTPOISON);
	export_constant(STATUS_VENOMIMPRESS);
	export_constant(STATUS_VENOMSPLASHER);
	export_constant(STATUS_DARKCLAW);
	export_constant(STATUS_HALLUCINATIONWALK);
	export_constant(STATUS_INVISIBILITY);
	export_constant(STATUS_DANCINGBLADES);
	export_constant(STATUS_ENCHANTDEADLYPOISON);
	export_constant(STATUS_DAGGERQUICKEN);
	export_constant(STATUS_CLOSECONFINE);
	export_constant(STATUS_CLOSECONFINE2);
	export_constant(STATUS_STRIPACCESSORY);
	export_constant(STATUS_PLAGIARISM);
	export_constant(STATUS_KILLERINSTINCT);
	export_constant(STATUS_STALK);
	export_constant(STATUS_STRIPWEAPON);
	export_constant(STATUS_STRIPSHIELD);
	...
	export_constant(STATUS_LIVINGTORNADO);
	export_constant(STATUS_CYCLONICCHARGE);
	export_constant(STATUS_WINDRACER);
	export_constant(STATUS_SPIRITANIMAL);
	export_constant(STATUS_ULLREAGLETOTEM);
	export_constant(STATUS_UNLIMIT);
	export_constant(STATUS_TYPHOONFLOW);
	export_constant(STATUS_ZEPHYRSNIPING);
	export_constant(STATUS_WINDMILLPOEM);
	export_constant(STATUS_ACCOUSTICRYTHM);
	export_constant(STATUS_IMPRESSIVERIFF);
	export_constant(STATUS_MAGICSTRINGS);
	export_constant(STATUS_ECHONOCTURNAE);
	export_constant(STATUS_MOONLIGHTSONATA);
	export_constant(STATUS_PAGANPARTY);
	export_constant(STATUS_MARIONETTE);
	export_constant(STATUS_MARIONETTE2);
	export_constant(STATUS_BATTLEDRUMS);
	export_constant(STATUS_TRICKDEAD);
	export_constant(STATUS_WEIGHT50);
	export_constant(STATUS_WEIGHT90);
	export_constant(STATUS_ASPDPOTION0);
	export_constant(STATUS_ASPDPOTION1);
	export_constant(STATUS_ASPDPOTION2);
	export_constant(STATUS_ASPDPOTION3);
	export_constant(STATUS_STRFOOD);
	export_constant(STATUS_AGIFOOD);
	export_constant(STATUS_VITFOOD);
	export_constant(STATUS_INTFOOD);
	export_constant(STATUS_DEXFOOD);
	export_constant(STATUS_LUKFOOD);
	export_constant(STATUS_COMA); 
	export_constant(STATUS_SPHERE_1);
	export_constant(STATUS_SPHERE_2);
	export_constant(STATUS_SPHERE_3);
	export_constant(STATUS_SPHERE_4);
	export_constant(STATUS_SPHERE_5);
	export_constant(STATUS_NOCHAT);
	export_constant(STATUS_PUSHCART);
	export_constant(STATUS_ALL_RIDING);
	export_constant(STATUS_ALL_RIDING_REUSE_LIMIT);
	export_constant(STATUS_CLAN_INFO);
	export_constant(STATUS_SWORDCLAN);
	export_constant(STATUS_ARCWANDCLAN);
	export_constant(STATUS_GOLDENMACECLAN);
	export_constant(STATUS_CROSSBOWCLAN);
	export_constant(STATUS_JUMPINGCLAN);
	export_constant(STATUS_INCATKRATE);
	export_constant(STATUS_INCDEFRATE);
	export_constant(STATUS_MDEF_RATE);
	export_constant(STATUS_DEF_RATE);
	export_constant(STATUS_DEFSET);
	export_constant(STATUS_MDEFSET);
	export_constant(STATUS_NORECOVER_STATE);
	export_constant(STATUS_ASURASTRIKE2); //! NOTE: This SC should be right before SC_MAX); so it doesn't disturb if RENEWAL is disabled
	/* status icons */
	...
	export_deprecated_constant2("SI_SK_HT_ELEMENTALTOTEM_OPERATOR",809);
	export_deprecated_constant2("SI_GUILD_STORAGE",810);
	export_deprecated_constant2("SI_GC_POISONINGWEAPON_OPERATOR",811);
	export_deprecated_constant2("SI_SK_MS_WEAPONREFINE_OPERATOR",812);
	export_deprecated_constant2("SI_SK_BS_REPAIRWEAPON_OPERATOR",813);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_COMBO1);
	export_constant(EFST_COMBO2);
	export_constant(EFST_COMBO3);
	export_constant(EFST_COMBO4);
	export_constant(EFST_COMBO5);
	export_constant(EFST_COMBO6);
	export_constant(EFST_COMBO7);
	export_constant(EFST_COMBO8);
	export_constant(EFST_COMBO9);
	export_constant(EFST_COMBO10);
	...
	export_constant(EFSK_AS_STEALTH);
	...
	export_constant(EFSK_AS_STEALTH2);
	...
	export_constant(EFST_SK_HT_ELEMENTALTOTEM_OPERATOR);
	export_constant(EFST_SK_HT_MYSTICTOTEM_OPERATOR);
	export_constant(EFST_GUILD_STORAGE);
	export_constant(EFST_GC_POISONINGWEAPON_OPERATOR);
	export_constant(EFST_SK_MS_WEAPONREFINE_OPERATOR);
	export_constant(EFST_SK_BS_REPAIRWEAPON_OPERATOR);
	...
	export_constant(EFST_WATK_ELEMENT);
	export_constant(EFST_COIN_DEX);
	export_constant(EFST_COIN_LUK);
	export_constant(EFST_STORE_SPELLBOOK);
/// @APIHOOK_END
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(EF_SK_EX_DARKCLAW);
	export_constant(EF_SK_CM_DRAGONBREATH);
	...
	export_constant(EF_SK_BI_OFFERTORIUM);
	export_constant(EF_SK_SO_VOIDMAGEPRODIGY);
	export_constant(EF_GN_ILLUSIONDOPING);
	export_constant(EF_NC_MAGMA_ERUPTION);
	export_constant(EF_SK_CM_MILLENIUMSHIELDS);
	export_constant(EF_BLOODDRAIN2);
	export_constant(EF_NPC_WIDEWEB);
	export_constant(EF_NPC_BURNT);
	export_constant(EF_NPC_CHILL);
	export_constant(EF_SK_ST_UNLIMIT);
	export_constant(EF_SK_BI_OFFERTORIUM_RING);
	...
	export_constant(HAT_EF_SK_SO_VOIDMAGEPRODIGY);
	export_constant(HAT_EF_SK_BI_OFFERTORIUM_RING);
