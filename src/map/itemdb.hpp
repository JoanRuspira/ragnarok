...
enum item_itemid : t_itemid
{
	...
	ITEMID_HOLY_GHOST_TOTEM             = 11,
	ITEMID_CORRUPT_TOTEM                = 12,
	ITEMID_SACRED_WAVE_TOTEM            = 13,
	ITEMID_EVIL_EYE_TOTEM               = 14,
	ITEMID_GREEN_PLANT                  = 22,
	ITEMID_RED_PLANT                    = 23,
	ITEMID_ORANGE_PLANT                 = 24,
	ITEMID_YELLOW_PLANT                 = 25,
	ITEMID_WHITE_PLANT                  = 26,
	ITEMID_BLUE_PLANT                   = 33,
	ITEMID_SHINING_PLANT                = 27,
	ITEMID_GREEN_MUSHROOM               = 28,
	ITEMID_YELLOW_MUSHROOM              = 29,
	ITEMID_BLUE_MUSHROOM                = 30,
	ITEMID_RED_MUSHROOM                 = 31,
	ITEMID_ORANGE_HERB                  = 32,
	ITEMID_SOLID_TRUNK                  = 1067,
	ITEMID_WIND_ESSENCE                 = 7523,
	ITEMID_WATER_ESSENCE                = 7522,
	ITEMID_FIRE_ESSENCE                 = 7521,
	ITEMID_SHADOW_ESSENCE               = 7524,
	ITEMID_HOLY_ESSENCE                 = 7525,
	ITEMID_GHOST_ESSENCE                = 7526,
	ITEMID_NEUTRAL_ESSENCE              = 7527,
	...
	ITEMID_MEDICINE_BOWL                = 7134,
	ITEMID_POTION_GUIDE = 7144,
	ITEMID_SLIM_POTION_GUIDE = 7133,
	ITEMID_PLANT_BOTTLE_GUIDE = 7130,
	ITEMID_ACID_BOTTLE_GUIDE = 7129,
	ITEMID_FIRE_BOTTLE_GUIDE = 7128,
	ITEMID_ALCOHOL_GUIDE = 7127,
	ITEMID_GLISTENING_COAT_GUIDE = 7132,
	ITEMID_ELEMENTAL_POTION_GUIDE = 7434,
	ITEMID_THUNDER_RESIST_POTION = 12121,
	ITEMID_EARTH_RESIST_POTION = 12120,
	ITEMID_COLD_RESIST_POTION = 12119,
	ITEMID_FIRE_RESIST_POTION = 12118,
	ITEMID_GREEN_HERB = 511,
	ITEMID_RED_HERB = 507,
	ITEMID_YELLOW_HERB = 508,
	ITEMID_WHITE_HERB = 509,
	ITEMID_BLUE_HERB = 510,
	ITEMID_YGGDRASIL_SEED = 608,
	ITEMID_SMELTING_MANUAL = 6969,
	ITEMID_BASIC_SWORD_FORGING_MANUAL = 6970,
	ITEMID_BASIC_DAGGER_FORGING_MANUAL = 6971,
	ITEMID_BASIC_AXE_FORGING_MANUAL = 6972,
	ITEMID_BASIC_MACE_FORGING_MANUAL = 6973,
	ITEMID_BASIC_KNUCKLE_FORGING_MANUAL = 6974,
	ITEMID_BASIC_SPEAR_FORGING_MANUAL = 6975,
};
