...
{
	status_change_start(src, bl, STATUS_FREEZE, 10000, skill_lv, 0, 0, 0, skill_lv * 2000, SCSTART_NONE);
}
...
{
	status_change_start(src, bl, STATUS_STONECURSE, 10000, skill_lv, 0, 0, 0, skill_lv * 2000, SCSTART_NONE);
